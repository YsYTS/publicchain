...
func (cli *Cli) Run() {
	...
	genesisAddress := createBlockchainCmd.String("address", "", "creating genesisblock and package data to database")

	printChainCmd := flag.NewFlagSet("printchain", flag.ExitOnError)

	getBalanceCmd := flag.NewFlagSet("getbalance", flag.ExitOnError)
	balanceAddress := getBalanceCmd.String("address", "", "check balance...")

	sendCmd := flag.NewFlagSet("send", flag.ExitOnError)
	sendFrom := sendCmd.String("from", "", "origin address...")
	sendTo := sendCmd.String("to", "", "target address...")
	...
	if createBlockchainCmd.Parsed() {
		if *genesisAddress == "" {
			fmt.Println("createblockchain failed")
			cli.printUsage()
			os.Exit(1)
		}
		fmt.Println("Creating genesisblock and package data to database.")
	}
	...
	if getBalanceCmd.Parsed() {
		...
		fmt.Printf("Checking the balance of %s \n", *balanceAddress)
	}
